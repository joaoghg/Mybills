export const transactions = {
  ...
  dateLabel: 'Data',
  competenceMonthLabel: 'Contabilizar em',
  competenceMonthHint: 'Mês do resumo. A data do lançamento não muda.',
  competencePreviousMonth: 'Mês de competência anterior',
  competenceNextMonth: 'Próximo mês de competência',
  ...
  competenceMonthLabelHistory: 'Contabilizado em {{month}}',
  receivedInMonthLabel: 'Recebido em {{month}}',
