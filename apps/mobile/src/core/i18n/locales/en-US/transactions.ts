export const transactions = {
  ...
  dateLabel: 'Date',
  competenceMonthLabel: 'Count in',
  competenceMonthHint: 'Cash-flow month. The transaction date stays the same.',
  competencePreviousMonth: 'Previous competence month',
  competenceNextMonth: 'Next competence month',
  ...
  competenceMonthLabelHistory: 'Counted in {{month}}',
  receivedInMonthLabel: 'Received in {{month}}',
