...
Then implement working code (HTML/CSS/JS, React, React Native, Vue, etc.) that is:
...
- **Color & Theme**: Commit to a cohesive aesthetic. Use variables for consistency. Dominant colors with sharp accents outperform timid, evenly-distributed palettes.
